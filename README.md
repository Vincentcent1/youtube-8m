...
curl data.yt8m.org/download.py | shard=1,100 partition=2/video/validate mirror=asia python
curl data.yt8m.org/download.py | shard=1,100 partition=2/video/test mirror=asia python

# Frame-level
mkdir -p ~/yt8m/v2/frame
cd ~/yt8m/v2/frame
curl data.yt8m.org/download.py | shard=1,100 partition=2/frame/train mirror=asia python
curl data.yt8m.org/download.py | shard=1,100 partition=2/frame/validate mirror=asia python
curl data.yt8m.org/download.py | shard=1,100 partition=2/frame/test mirror=asia python
